...
describe('getExamples', () => {
	...
	test('prompts user if examples found and interactive', async () => {
		...
		expect(result.excludedFiles).toContain('schemas/exampleTable.graphql');
		...
		expect(result.excludedFiles).not.toContain('resources/exampleTable.ts');
		expect(result.excludedFiles).not.toContain('resources/exampleTable.js');
